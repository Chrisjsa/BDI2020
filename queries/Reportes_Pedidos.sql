...
--- DETALLE DE INGRESOS
SELECT pre.fk_orden_evento as id_orden_evento, pre.id_presupuesto, met.numero_factura, met.razon, est.nombre as estatus, prepa.fecha as fecha_pago, pre.total as monto
