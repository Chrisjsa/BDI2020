...
SELECT *
FROM arma_tu_fiesta.locacion as loc, arma_tu_fiesta.templo as tem, arma_tu_fiesta.coordenada as coor
WHERE loc.tipo = 'Templo' AND tem.fk_templo = loc.id_locacion AND coor.fk_locacion = loc.id_locacion;
