exports.LEER_CLIENTES =
  "SELECT per.id_persona as id_persona, per.cedula, per.p_nombre, per.p_apellido, per.s_nombre, em.correo as correo, usu.password as password, tel.numero as telefono, per.s_apellido, per.fecha_nacimiento, per.sexo as sexo, per.estado_civil as estado_civil,  lug.nombre as reside FROM arma_tu_fiesta.persona as per, arma_tu_fiesta.usuario as usu, arma_tu_fiesta.email as em, arma_tu_fiesta.telefono as tel, arma_tu_fiesta.lugar as lug WHERE per.fk_residencia = lug.id_lugar and tel.fk_persona = per.id_persona and em.fk_persona = per.id_persona and usu.fk_persona = per.id_persona;"
