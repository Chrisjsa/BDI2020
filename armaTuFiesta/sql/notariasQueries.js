...
exports.CREAR_NOTARIAS =
  "SET @pertenece = (ID_lugar); INSERT INTO arma_tu_fiesta.locacion (nombre, tipo, fk_localizacion) VALUES (':nombre', ':tipo', @pertenece); SET @notaria = (SELECT pkLocacion FROM (SELECT id_locacion as pkLocacion FROM arma_tu_fiesta.locacion WHERE nombre LIKE ':nombre' AND tipo = 'Notaria') as tablaNotaria); INSERT INTO arma_tu_fiesta.notaria (fk_Notaria, nombre_notario) VALUES (@notaria, ':notario'); INSERT INTO arma_tu_fiesta.telefono (numero, fk_locacion) VALUES ('Telefono', @notaria); INSERT INTO arma_tu_fiesta.coordenada (latitud, longitud, fk_locacion) VALUES ('Latitud', 'Longitud', @notaria);"

exports.ACTUALIZAR_NOTARIAS =
  "SET @notaria = (ID_notaria); UPDATE arma_tu_fiesta.locacion SET nombre = ':nombre' WHERE id_locacion = @notaria; UPDATE arma_tu_fiesta.notaria SET nombre_notario = ':notario' WHERE fk_notaria = @notaria;"
